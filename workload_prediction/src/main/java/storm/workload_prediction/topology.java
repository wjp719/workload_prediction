...
public class topology {
	...
	builder.setBolt("predict_Bolt", new predict_Bolt(),2).shuffleGrouping("VM_Spout");
	builder.setBolt("DB_Bolt_M", new DB_Bolt(),2).shuffleGrouping("predict_Bolt");
	//物理机
...
//	builder.setBolt("DB_Bolt_PM_C", new DB_Bolt(),5).shuffleGrouping("PM_C_Bolt");
     ...
     if (args != null && args.length > 0) {
        ...
        如果你分配的slot数超过了你的物理节点所拥有的worker数目的话，有可能提交不成功，假如你的集群上面已经有了
